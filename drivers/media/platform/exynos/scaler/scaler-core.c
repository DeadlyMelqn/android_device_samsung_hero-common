...
static void sc_calc_intbufsize(struct sc_dev *sc, struct sc_int_frame *int_frame)
{
	...
	printk("%s : %d %d %d\n", __func__, int_frame->src_addr.ysize,
			int_frame->src_addr.cbsize, int_frame->src_addr.crsize);
	printk("%s : %d %d %d\n", __func__, int_frame->dst_addr.ysize,
			int_frame->dst_addr.cbsize, int_frame->dst_addr.crsize);
}
...
static bool initialize_initermediate_frame(struct sc_ctx *ctx)
{
	...
	printk("%s : %d %d %d\n", __func__, ctx->i_frame->src_addr.ysize,
			ctx->i_frame->src_addr.cbsize, ctx->i_frame->src_addr.crsize);
	printk("%s : %d %d %d\n", __func__, ctx->i_frame->dst_addr.ysize,
			ctx->i_frame->dst_addr.cbsize, ctx->i_frame->dst_addr.crsize);
